...
class DynamicReplicaDepth(BaseMultiViewDataset):
    ...
    def __getitem__(self, index: Any):
        ...
        extrinsics = np.load(osp.join(self.ROOT, self.scenes[scene_id], "extrinsics.npy"))[img_idxs_local]
        intrinsics = np.load(osp.join(self.ROOT, self.scenes[scene_id], "intrinsics.npy"))[img_idxs_local]
        ...
        for i in range(self.num_views):
            ...
            # print(img_aug.shape, img_aug.dtype)
            # exit()
