...
class DynamicReplica(BaseMultiViewDataset):
    ...
    def __init__(self, *args, ROOT: str, **kwargs):
        ...
        list_data = [dir for dir in sorted(os.listdir(split_dir)) if '_obj' in dir]
        seq_cnt = 0
    ...
    def __getitem__(self, index: Any):
        ...
        mask_nonnan = valid_data.all(axis=(0, 2)) & visibilities[0].astype(bool)
        # print(visibilities.shape, trajs_3d.shape, valid_data.shape, mask_nonnan.shape)
        # exit()
        ...
        for i in range(self.num_views):
            ...
            # print(t_k_3d_world.shape, t_k_3d_cam.shape, visibilities[i].shape)
            # (20388, 3) (20388, 3) (20388,)
            # exit()
            views.append(dict(
                img=ImgNorm(img_aug),
        ...
        # imageio.mimsave('./replica_exp.gif', frames_track, fps=6)
        # imageio.mimsave('./replica_vid.gif', frames, fps=6)
        # exit()
