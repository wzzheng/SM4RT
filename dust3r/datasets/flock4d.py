...
class Flock4D(BaseMultiViewDataset):
    ...
    def __init__(self, *args, ROOT: str, **kwargs):
        ...
        list_data = [dir for dir in sorted(os.listdir(split_dir))]
        seq_cnt = 0
    ...
    def __getitem__(self, index: Any):
        ...
        for i in range(self.num_views):
            ...
            # print(valid_data.shape, t_k_3d_world.shape)
            # exit()
            views.append(dict(
                img=img_out,
        ...
        # imageio.mimsave('./flock4d_exp.gif', frames_track, fps=2)
        # imageio.mimsave('./flock4d_vid.gif', frames, fps=2)
        # exit()
